...
function(SDL_AddCommonCMakeOptions)
  include(CMakeParseArguments)
  cmake_parse_arguments(ARGS "" "WERROR_OPTION_NAME" "" ${ARGN})

  if(NOT ARGS_WERROR_OPTION_NAME)
    set(ARGS_WERROR_OPTION_NAME "SDL_WERROR")
  endif()
  option(${ARGS_WERROR_OPTION_NAME} "Enable -Werror" OFF)

  define_property(DIRECTORY PROPERTY SDL_WERROR_OPTION_NAME
    BRIEF_DOCS "Option name to enable/disable -Werror"
    FULL_DOCS "Option name to enable/disable -Werror"
  )
  set_property(DIRECTORY "${CMAKE_CURRENT_SOURCE_DIR}" PROPERTY SDL_WERROR_OPTION_NAME "${ARGS_WERROR_OPTION_NAME}")
endfunction()

function(SDL_AddCommonCompilerFlags TARGET)
  get_property(enable_werror DIRECTORY "${CMAKE_CURRENT_SOURCE_DIR}" PROPERTY SDL_WERROR_OPTION_NAME)
